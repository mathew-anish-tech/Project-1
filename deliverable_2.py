...
Original file is located at
    https://colab.research.google.com/drive/1gRsPCVCvgnM2dvP_y9K4PfKLyDDAJhIZ
"""
...
# Set your authtoken
Anish = ngrok.set_auth_token("2tCVmjM9usuyE33FUDd39H7JULB_3pGUyngXGcHMCxcNkeCMf") # Replace YOUR_AUTHTOKEN with your actual authtoken


# Start a tunnel to expose Ollama API
...
class URLValidator:
    ...
    # def check_google_scholar(self, url: str) -> int:
       ...
       # serpapi_key = self.ngrok_key
       # params = {"q": url, "engine": "google_scholar", "api_key": serpapi_key}
        ##try:
          #  response = requests.get("http://xyz.ngrok.io/api/search", params=params)
           # data = response.json()
    ...
    def generate_explanation(self, domain_trust, similarity_score,  bias_score, citation_score, final_score) -> str:
    ...
    def rate_url_validity(self, user_query: str, url: str) -> dict:
        ...
        final_score = (
            ...
            (0.1 * self.detect_bias(content))
        )

        stars, icon = self.get_star_rating(final_score)
        explanation = self.generate_explanation(domain_trust, similarity_score,  self.detect_bias(content), final_score)
        ...
        return {
            "raw_score": {
                ...
                "Bias Score": self.detect_bias(content),
...
duckduckgo_search("Python programming")